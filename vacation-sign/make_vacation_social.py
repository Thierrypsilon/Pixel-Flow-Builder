#!/usr/bin/env python3
"""
make_vacation_social.py — "JAHRESURLAUB" Social-Media-Grafiken für Bikecenter Meyer.

Erzeugt in einem Durchlauf drei Formate (Instagram Feed, Instagram Story/Reel,
Facebook/Quadrat) als PNG sowie eine mehrseitige PDF, im selben Design wie die
übrigen Schilder (Papierweiß, Graphit-Tinte, Signal-Orange-Akzentband,
Big-Shoulders-Headline, Mono-Detailtext), für den Jahresurlaub.

Ausführen:
    python make_vacation_social.py
"""
...
def main():
    ...
    pdf_path = os.path.join(OUTPUT_DIR, "social_urlaub.pdf")
