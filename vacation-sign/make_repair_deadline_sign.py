#!/usr/bin/env python3
"""
make_repair_deadline_sign.py — Türschild "Annahmeschluss Reparaturen" für
Bikecenter Meyer, A4-druckfertig.

Gleiche Design-Sprache wie die übrigen Schilder (Papierweiß, Graphit-Tinte,
Signal-Orange-Akzentband, Big-Shoulders-Headline, Mono-Detailtext). Weist vor
dem Jahresurlaub darauf hin, dass Reparaturen nur noch bis zu einem Stichtag
angenommen werden, damit alles rechtzeitig fertig wird.

Ausführen:
    python make_repair_deadline_sign.py
"""
...
MARKER_TEXT = "— VOR DEM JAHRESURLAUB · AVANT LES CONGÉS —"

MESSAGE_HEADLINE_DE = "REPARATUREN"
MESSAGE_HEADLINE_FR = "RÉPARATIONS"

# Stichtag als Terminblock. Beliebig viele Einträge möglich.
CLOSURE_ENTRIES = [
    {
        "day_de": "MITTWOCH · 29. JULI 2026",
        "day_fr": "Mercredi 29 juillet 2026",
        "detail_de": "Letzter Tag für die Reparatur-Annahme",
        "detail_fr": "Dernier jour pour déposer une réparation",
    },
]

# Prominente Botschaft direkt unter dem Terminblock.
RETURN_DE = "Annahme nur noch bis zu diesem Tag"
RETURN_FR = "Dépôts acceptés jusqu'à cette date"

REASON_DE = "So bekommen wir vor dem Urlaub alles rechtzeitig fertig."
REASON_FR = "Ainsi nous terminons tout à temps avant les congés."
...
DATE_TICK_H = 10
DATE_BORDER_THICK = 2
GAP_SCHEDULE_RETURN = 40

RETURN_DE_SIZE = 40
RETURN_FR_SIZE = 27
RETURN_LINE_GAP = 8
GAP_RETURN_REASON = 34
...
def build_blocks(draw, canvas, ss_w, scale, ss, content_scale, gap_mult, font_paths, bike_icon_master):
    ...
    blocks = [
        ...
        make_schedule_block(CLOSURE_ENTRIES, GAP_SCHEDULE_RETURN),
        make_two_line_block(RETURN_DE, RETURN_DE_SIZE, INK, RETURN_FR, RETURN_FR_SIZE, INK_SOFT,
...
def main():
    ...
    png_path = os.path.join(OUTPUT_DIR, "repair_deadline_sign.png")
    img.save(png_path, "PNG", dpi=(300, 300))

    pdf_path = os.path.join(OUTPUT_DIR, "repair_deadline_sign.pdf")
